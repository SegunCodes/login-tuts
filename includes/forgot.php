    ...
    if(empty($email)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            if(mysqli_stmt_num_rows($stmt) == 1){
                ...
                $url = "http://localhost/login_tuts/reset.php?token=$token&email=$email";
                //send the email
                ...
                try {
                    ...
                    $mail->Username   = 'seguncodes07@gmail.com';                     //SMTP username
                    $mail->Password   = 'azys ssjo ddjs qblp';                               //SMTP password
                    $mail->SMTPSecure = 'ssl';            //Enable implicit TLS encryption
                    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                    //Recipients
                    $mail->From = 'seguncodes07@gmail.com'; 
